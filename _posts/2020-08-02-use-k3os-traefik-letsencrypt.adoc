...
:page-layout: post
:page-date: 2020-08-02 14:00:00 +0200
...
To instruct Traefik to route a subdomain with HTTPS to a service you just need to create a https://kubernetes.io/docs/concepts/services-networking/ingress/[Ingress,window=_blank] for your service:
