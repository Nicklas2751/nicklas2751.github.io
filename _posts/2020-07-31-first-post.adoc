...
The blog itself is made with https://jekyllrb.com/[Jekyll] and https://github.com/asciidoctor/jekyll-asciidoc[AsciiDoc]. It's hosted on https://github.com/nicklas2751/nicklas2751.github.io[GitHub] where you can also find the https://github.com/nicklas2751/nicklas2751.github.io[source]. Because this don't allow to send E-Mails on server side, I created an AWS Lambda for the contact form.
